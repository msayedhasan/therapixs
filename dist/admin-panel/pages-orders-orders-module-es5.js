...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-orders-orders-module"], {
  ...
  function srcAppPagesOrdersOrdersComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function OrdersComponent_ng_template_41_ng_template_12_ng_container_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function OrdersComponent_ng_template_41_ng_template_12_ng_container_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementContainerStart"](0);
    ...
    function OrdersComponent_ng_template_41_ng_template_12_ng_container_3_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementContainerStart"](0);
    ...
    function OrdersComponent_ng_template_41_ng_template_12_ng_container_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementContainerStart"](0);
    ...
    function OrdersComponent_ng_template_41_ng_template_12_ng_container_5_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementContainerStart"](0);
    ...
    function OrdersComponent_ng_template_41_ng_template_15_ng_container_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function OrdersComponent_ng_template_41_ng_template_15_ng_container_0_Template_a_click_1_listener() {
          ...
          return ctx_r35.openModal(_r4, item_r31._id);
        });
    ...
    function OrdersComponent_ng_template_41_ng_template_15_ng_container_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function OrdersComponent_ng_template_41_ng_template_15_ng_container_1_Template_a_click_1_listener() {
          ...
          return ctx_r38.openModal(_r6, item_r31._id);
        });
    ...
    function OrdersComponent_ng_template_41_ng_template_15_ng_container_2_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function OrdersComponent_ng_template_41_ng_template_15_ng_container_2_Template_a_click_1_listener() {
          ...
          return ctx_r41.openModal(_r8, item_r31._id);
        });
    ...
    function OrdersComponent_ng_template_41_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("reload", function OrdersComponent_ng_template_41_Template_data_table_reload_1_listener($event) {
          ...
          return ctx_r44.reloadItems($event);
        });
    ...
    var OrdersComponent = /*#__PURE__*/function () {
      function OrdersComponent(ordersService, modalService, toastr) {
    ...
    var OrdersService = /*#__PURE__*/function () {
      ...
      _createClass(OrdersService, [{
        ...
        value: function confirmOne(itemId) {
          return this.http["delete"](_config_variables__WEBPACK_IMPORTED_MODULE_3__["baseUrl"] + "/order/".concat(itemId));
        }
      }, {
        key: "shipOne",
        value: function shipOne(itemId) {
          return this.http.get(_config_variables__WEBPACK_IMPORTED_MODULE_3__["baseUrl"] + "/order/".concat(itemId));
        }
      }, {
        key: "deliverOne",
        value: function deliverOne(form) {
