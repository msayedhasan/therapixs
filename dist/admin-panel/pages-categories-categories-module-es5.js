...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-categories-categories-module"], {
  ...
  function srcAppPagesCategoriesAddCategoryAddCategoryComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AddCategoryComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 25,
      vars: 49,
      consts: [[1, "grid-center-noGutter"], [1, "col-20_sm-22_xs-23", "grid-center-noGutter", "content"], [1, "title", "col-24", "grid-center"], [1, "form", "col-23"], [1, "grid-middle-spaceBetween-noGutter"], [1, "form-group", "grid-center-middle-noGutter", "col-24"], [1, "col-24", "grid-center"], [3, "fieldId", "image", "control"], ["type", "text", 1, "col-11_sm-24", 3, "label", "labelAr", "fieldId", "required", "placeholder", "tooltipMsg", "control", "fieldClass"], ["type", "text", 1, "col-11_sm-24", "grid", 3, "label", "labelAr", "fieldId", "rtldirection", "placeholder", "tooltipMsg", "control", "fieldClass"], [1, "col-11_sm-24", 3, "label", "labelAr", "placeholderAr", "fieldId", "ItemsList", "fieldClass", "required", "itemselected"], [1, "grid-right"], ["type", "submit", 1, "btn", "col-3_sm-5_xs-6", "color1", "round", 3, "disabled", "click"], ["type", "button", 1, "btn", "col-3_sm-5_xs-6", "color2", "round", 3, "routerLink"]],
  ...
  function srcAppPagesCategoriesCategoriesComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function CategoriesComponent_ng_template_69_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function CategoriesComponent_ng_template_69_Template_button_click_13_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r35);
    ...
    var CategoriesComponent = /*#__PURE__*/function () {
      function CategoriesComponent(categoriesService, modalService, languageService, toastr, spinner) {
        var _this7 = this;
        ...
        this.langSub = this.languageService.currentLanguage.subscribe(function (lang) {
          _this7.currentLang = lang;

          if (_this7.currentLang && _this7.currentLang === 'ar') {
            _this7.arabic = true;
          } else {
            _this7.arabic = false;
          }
  ...
  function srcAppPagesCategoriesEditCategoryEditCategoryComponentTs(module, __webpack_exports__, __webpack_require__) {
        ...
        value: function getOne(id) {
          ...
          this.categoriesService.getOne(id).subscribe(function (res) {
            ...
            if (res['data']['productAttributes'] && res['data']['productAttributes'].length > 0) {
              var productAttributes = _this10.form.get('productAttributes');
              ...
              for (var index = 0; index < res['data']['productAttributes'].length; index++) {
                ...
                productAttributes.controls[index] = _this10.fb.group({
                  _id: [''],
                  name: _this10.fb.group({
                    en: [''],
                    ar: ['']
                  })
                });
                productAttributes.controls[index].get('_id').patchValue(_this10.selectedProductAttribute[index]._id);
                productAttributes.controls[index].get('name').get('en').patchValue(_this10.selectedProductAttribute[index].nameEn);
                productAttributes.controls[index].get('name').get('ar').patchValue(_this10.selectedProductAttribute[index].nameAr);
              }
            }
          }, function (error) {
            console.log(error);
    ...
    EditCategoryComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 25,
      vars: 41,
      consts: [[1, "grid-center-noGutter"], [1, "col-20_sm-22_xs-23", "grid-center-noGutter", "content"], [1, "title", "col-24", "grid-center"], [1, "form", "col-23"], [1, "grid-middle-spaceBetween-noGutter"], [1, "form-group", "grid-center-middle-noGutter", "col-24"], [1, "col-24", "grid-center"], [3, "fieldId", "image", "control"], ["type", "text", 1, "col-11_sm-24", 3, "label", "fieldId", "required", "placeholder", "tooltipMsg", "control", "fieldClass"], ["type", "text", 1, "col-11_sm-24", "grid", 3, "label", "fieldId", "rtldirection", "placeholder", "tooltipMsg", "control", "fieldClass"], [4, "ngIf"], [1, "grid-right"], ["type", "submit", 1, "btn", "col-3_sm-5_xs-6", "color1", "round", 3, "disabled", "click"], ["type", "button", 1, "btn", "col-3_sm-5_xs-6", "color2", "round", 3, "routerLink"], [1, "col-11_sm-24", 3, "label", "labelAr", "placeholderAr", "fieldId", "initialSelectedList", "ItemsList", "fieldClass", "required", "itemselected"]],
