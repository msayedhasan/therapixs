...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-stores-stores-module"], {
    ...
    AddStoreComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function AddStoreComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AddStoreComponent_Template_button_click_12_listener() {
      ...
      _createClass(EditStoreComponent, [{
        ...
        value: function getOne(id) {
          ...
          this.storesService.getOne(id).subscribe(function (res) {
            ...
            _this2.form.get('numberOfBranches').patchValue(res['data']['numberOfBranches']);
          }, function (error) {
            console.log(error);
    ...
    EditStoreComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function EditStoreComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditStoreComponent_Template_button_click_12_listener() {
            return ctx.onSubmit(ctx.form.value);
          });
  ...
  function srcAppPagesStoresStoresComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function StoresComponent_ng_template_40_ng_template_3_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function StoresComponent_ng_template_40_ng_template_6_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function StoresComponent_ng_template_40_ng_template_9_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function StoresComponent_ng_template_40_ng_template_9_Template_a_click_3_listener() {
    ...
    StoresComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterLinkWithHref"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgTemplateOutlet"], angular7_data_table__WEBPACK_IMPORTED_MODULE_6__["DataTable"], angular7_data_table__WEBPACK_IMPORTED_MODULE_6__["DataTableColumn"], ngx_bootstrap_tooltip__WEBPACK_IMPORTED_MODULE_7__["TooltipDirective"]],
  ...
  function srcAppPagesStoresStoresModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _stores_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./stores-routing.module */
    "./src/app/pages/stores/stores-routing.module.ts");
    /* harmony import */


    var _stores_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./stores.component */
    "./src/app/pages/stores/stores.component.ts");
    /* harmony import */
    ...
    var _add_store_add_store_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./add-store/add-store.component */
    "./src/app/pages/stores/add-store/add-store.component.ts");
    /* harmony import */


    var _edit_store_edit_store_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./edit-store/edit-store.component */
    "./src/app/pages/stores/edit-store/edit-store.component.ts");
    /* harmony import */
